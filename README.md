...
Create a new Skill and choose Dialog Skill, then select Import Skill and upload either the skill-banking-balance-enquiry.json or the skill-pizza-order-book-table.json. You will see the intents, entities and the dialog. To learn more about these and the Watson Assistant click [here](https://github.com/FelixAugenstein/digital-tech-tutorial-watson-assistant).
